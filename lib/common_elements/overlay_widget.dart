...
class OverlayWidget extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _buildAnimatedOverlay(Widget content) {
    ...
    final showOverlay = useCallback(() {
      ...
      final newOverlayEntry = OverlayEntry(
          builder: (context) => Stack(children: [
                ...
                Positioned(left: offset!.dx - horizontalPadding, top: offset.dy - verticalPadding, child: GestureDetector(onTap: () {}, child: Material(color: backgroundColor ?? Colors.transparent, child: _buildAnimatedOverlay(overlayContent(removeOverlay)))))
              ]));
